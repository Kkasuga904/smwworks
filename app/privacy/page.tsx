...
// プライバシーポリシーページ - 地域名は.env.localで管理
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 space-y-8">
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                {/* サイト名を動的に表示 */}
                {config.siteName}（以下、「当社」といいます。）は、本ウェブサイト上で提供するサービス（以下、「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。
              </p>
            </div>
